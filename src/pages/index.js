          ...
          <Fade in={this.state.showWork}>
            <div className="section-wrapper">
              <div className="section-header" style={styles.header}>
                <h2 className="section-title" style={styles.title}>Cosa facciamo</h2>
          ...
          <Fade in={this.state.showPeople}>
            <div className="section-wrapper">
              <div style={styles.header}>
                <h2 className="section-title" style={styles.title}>Chi siamo</h2>
        ...
        >
          <Fade in={this.state.showContact}>
            <div className="contact-container">
              ...
              <div style={styles.header}>
                <h2 className="section-title" style={styles.title}>Contattaci</h2>
                <p style={styles.description}>Compila il form sottostante se vuoi un nostro assaggio.</p>
              </div>
              <form style={styles.contactForm} onSubmit={this.handleContactForm}>
                <Collapse in={this.state.messageError}>
                  <Message type="error" title="Error" description="Per favore fornisci i dati corretti per ogni campo" />
                </Collapse>
                <div style={{ width: '100%', display: 'flex', flexDirection: 'row' }}>
                  <Input name="userName" value={this.state.userName} onChange={this.handleInput} placeholder="Nome" />
                  <Input name="userEmail" value={this.state.userEmail} onChange={this.handleInput} placeholder="Email" />
                </div>
                <Input name="messageSubject" value={this.state.messageSubject} onChange={this.handleInput} placeholder="Oggetto" />
                <Input
